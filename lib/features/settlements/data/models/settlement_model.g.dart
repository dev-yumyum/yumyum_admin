...
SettlementModel _$SettlementModelFromJson(Map<String, dynamic> json) =>
    SettlementModel(
      ...
      platformFeeRate: json['platformFeeRate'] as String,
      platformFeeAmount: json['platformFeeAmount'] as String,
      deliveryFeeAmount: json['deliveryFeeAmount'] as String,
...
Map<String, dynamic> _$SettlementModelToJson(SettlementModel instance) =>
    <String, dynamic>{
      ...
      'deliveryFeeAmount': instance.deliveryFeeAmount,
