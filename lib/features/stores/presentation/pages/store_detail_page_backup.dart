...
class _StoreDetailPageState extends State<StoreDetailPage> {
  ...
  // 운영시간 관련
  String _operatingHoursType = 'SAME'; // SAME or DIFFERENT
  // 동일한 운영시간일 때
  String _commonStartHour = '09';
  String _commonStartMinute = '00';
  String _commonEndHour = '22';
  String _commonEndMinute = '00';
  // 평일/주말 다른 운영시간일 때
  String _weekdayStartHour = '09';
  String _weekdayStartMinute = '00';
  String _weekdayEndHour = '22';
  String _weekdayEndMinute = '00';
  String _weekendStartHour = '10';
  String _weekendStartMinute = '00';
  String _weekendEndHour = '23';
  String _weekendEndMinute = '00';
  ...
  void _updateControllers() {
    ...
    if (_store!.operatingHours != null && _store!.operatingHours!.isNotEmpty) {
      // 실제로는 operatingHours를 파싱해서 설정
      // 여기서는 샘플 데이터로 설정
      _operatingHoursType = 'SAME';
      _commonStartHour = '09';
      _commonStartMinute = '00';
      _commonEndHour = '22';
      _commonEndMinute = '00';
    } else {
      // 기본값 유지
  ...
  Future<void> _saveChanges() async {
    ...
    try {
      ...
      if (_operatingHoursType == 'SAME') {
        operatingHoursString = '평일/주말: $_commonStartHour:$_commonStartMinute-$_commonEndHour:$_commonEndMinute';
      } else {
        operatingHoursString = '평일: $_weekdayStartHour:$_weekdayStartMinute-$_weekdayEndHour:$_weekdayEndMinute / 주말: $_weekendStartHour:$_weekendStartMinute-$_weekendEndHour:$_weekendEndMinute';
      }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: AppSizes.lg),
              // _buildOperatingHoursSection(), // TODO: 운영시간 관리 기능 구현 예정
              SizedBox(height: AppSizes.lg),
  ...
  void _showMapDialog() {
    showDialog(
      ...
      builder: (BuildContext context) {
        // return MapEditDialog( // TODO: MapEditDialog 구현 예정
        return AlertDialog(
          title: Text('주소 수정'),
          content: Text('주소 수정 기능을 구현 중입니다.'),
          actions: [
            TextButton(
...
class _MapEditDialogState extends State<MapEditDialog> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(MdiIcons.clockOutline, color: AppColors.primary, size: AppSizes.iconMd),
                SizedBox(width: AppSizes.sm),
                Text(
                  '운영시간 관리',
                  style: TextStyle(
            ...
            if (_isEditMode) ...[
              ...
              Row(
                children: [
                  Expanded(
                    child: RadioListTile<String>(
                      title: Text('동일', style: TextStyle(fontSize: 16.sp)),
                      value: 'SAME',
                  ...
                  Expanded(
                    child: RadioListTile<String>(
                      title: Text('다름', style: TextStyle(fontSize: 16.sp)),
                      value: 'DIFFERENT',
                      groupValue: _operatingHoursType,
                      onChanged: (value) {
                        setState(() {
              ...
              // 운영시간 설정
              if (_operatingHoursType == 'SAME') 
                _buildCommonOperatingHours()
              else
                _buildSeparateOperatingHours(),
            ] else ...[
              // 보기 모드
  ...
  // 동일한 운영시간 설정
  /*
  Widget _buildCommonOperatingHours() {
    return Container(
      padding: EdgeInsets.all(AppSizes.md),
      decoration: BoxDecoration(
            ...
            children: [
              Expanded(
                child: _buildTimeSelector(
                  ...
                  _commonStartHour,
                  _commonStartMinute,
                  (hour) => setState(() => _commonStartHour = hour),
                  (minute) => setState(() => _commonStartMinute = minute),
                  isStartTime: true,
                ),
              ),
              SizedBox(width: AppSizes.md),
              Icon(MdiIcons.arrowRight, color: AppColors.textSecondary),
              SizedBox(width: AppSizes.md),
              Expanded(
                child: _buildTimeSelector(
                  '종료시간',
                  _commonEndHour,
                  _commonEndMinute,
                  (hour) => setState(() => _commonEndHour = hour),
                  (minute) => setState(() => _commonEndMinute = minute),
                  isStartTime: false,
                ),
              ),
            ],
  ...
  // 평일/주말 별도 운영시간 설정
  Widget _buildSeparateOperatingHours() {
    return Column(
      children: [
        // 평일 운영시간
        Container(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Icon(MdiIcons.calendarWeek, color: Colors.blue, size: AppSizes.iconSm),
                  SizedBox(width: AppSizes.sm),
                  Text(
                    '평일 (월~금)',
                    style: TextStyle(
                ...
                children: [
                  Expanded(
                    child: _buildTimeSelector(
                      ...
                      _weekdayStartHour,
                      _weekdayStartMinute,
                      (hour) => setState(() => _weekdayStartHour = hour),
                      (minute) => setState(() => _weekdayStartMinute = minute),
                      isStartTime: true,
                    ),
                  ),
                  SizedBox(width: AppSizes.md),
                  ...
                  Expanded(
                    child: _buildTimeSelector(
                      ...
                      _weekdayEndHour,
                      _weekdayEndMinute,
                      (hour) => setState(() => _weekdayEndHour = hour),
                      (minute) => setState(() => _weekdayEndMinute = minute),
                      isStartTime: false,
                    ),
                  ),
                ],
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Icon(MdiIcons.calendarWeekend, color: Colors.orange, size: AppSizes.iconSm),
                  SizedBox(width: AppSizes.sm),
                  Text(
                    '주말 (토~일)',
                    style: TextStyle(
                ...
                children: [
                  Expanded(
                    child: _buildTimeSelector(
                      ...
                      _weekendStartHour,
                      _weekendStartMinute,
                      (hour) => setState(() => _weekendStartHour = hour),
                      (minute) => setState(() => _weekendStartMinute = minute),
                      isStartTime: true,
                    ),
                  ),
                  SizedBox(width: AppSizes.md),
                  ...
                  Expanded(
                    child: _buildTimeSelector(
                      ...
                      _weekendEndHour,
                      _weekendEndMinute,
                      (hour) => setState(() => _weekendEndHour = hour),
                      (minute) => setState(() => _weekendEndMinute = minute),
                      isStartTime: false,
                    ),
                  ),
                ],
  ...
  Widget _buildTimeSelector(
    ...
    Function(String) onHourChanged,
    Function(String) onMinuteChanged,
    ...
    if (isStartTime) {
      // 시작시간: 00~24시
      hourOptions = List.generate(25, (index) => index.toString().padLeft(2, '0'));
    } else {
      // 종료시간: 00~익일 06시 (24시간 + 6시간)
      hourOptions = List.generate(31, (index) {
        if (index <= 24) {
          return index.toString().padLeft(2, '0');
        } else {
          return '익일 ${(index - 24).toString().padLeft(2, '0')}';
        }
      });
    }
    
    final minuteOptions = ['00', '15', '30', '45'];
          ...
          children: [
            ...
            Expanded(
              ...
              child: DropdownButtonFormField<String>(
                ...
                decoration: InputDecoration(
                  ...
                  contentPadding: EdgeInsets.symmetric(horizontal: AppSizes.sm, vertical: AppSizes.xs),
                  suffixText: '시',
                ),
                items: hourOptions.map((hour) => DropdownMenuItem(
                  value: hour.contains('익일') ? hour.split(' ')[1] : hour,
                  child: Text(
                    hour,
                    style: TextStyle(fontSize: 14.sp),
                  ),
                )).toList(),
                onChanged: (value) => onHourChanged(value!),
                isExpanded: true,
                menuMaxHeight: 200.h,
              ),
            ),
            ...
            Expanded(
              ...
              child: DropdownButtonFormField<String>(
                ...
                items: minuteOptions.map((minute) => DropdownMenuItem(
                  value: minute,
                  child: Text(
                    minute,
                    style: TextStyle(fontSize: 14.sp),
                ...
                onChanged: (value) => onMinuteChanged(value!),
              ),
            ),
          ],
        ),
  ...
  */
  ...
  // TODO: 운영시간 표시 메소드 구현 예정 
  /*
  Widget _buildOperatingHoursDisplay() {
    String displayText;
    if (_operatingHoursType == 'SAME') {
      displayText = '평일/주말 동일: $_commonStartHour:$_commonStartMinute ~ $_commonEndHour:$_commonEndMinute';
    } else {
      displayText = '''평일: $_weekdayStartHour:$_weekdayStartMinute ~ $_weekdayEndHour:$_weekdayEndMinute
주말: $_weekendStartHour:$_weekendStartMinute ~ $_weekendEndHour:$_weekendEndMinute''';
    }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(MdiIcons.clockCheck, color: AppColors.success, size: AppSizes.iconSm),
              SizedBox(width: AppSizes.sm),
              Text(
                '현재 설정된 운영시간',
                style: TextStyle(
...
// MapGridPainter 클래스 - 지도 격자를 그리기 위한 CustomPainter
class MapGridPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
