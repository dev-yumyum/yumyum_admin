...
class _StoreMenuPageState extends State<StoreMenuPage> with TickerProviderStateMixin {
  ...
  void _handleMenuItemAction(String action, int groupIndex, int itemIndex) {
    switch (action) {
      case 'edit':
        _navigateToMenuEditPage(groupIndex, itemIndex);
        break;
      case 'move':
  ...
  // 메뉴 수정 페이지로 이동
  void _navigateToMenuEditPage(int groupIndex, int itemIndex) {
    final item = _menuGroups[groupIndex]['items'][itemIndex];
    final groupName = _menuGroups[groupIndex]['name'];
    final menuId = '${groupName}_${item['name']}'; // 고유 ID 생성
    
    context.go('/stores/${widget.storeId}/menu/edit/$menuId', extra: {
      'item': item,
      'groupName': groupName,
          ...
          children: [
            Row(
              ...
              children: [
                Row(
                  children: [
                    Icon(MdiIcons.cog, color: AppColors.primary, size: AppSizes.iconMd),
                    SizedBox(width: AppSizes.sm),
                    Text(
                      '메뉴 옵션',
                      style: TextStyle(
                ...
                ElevatedButton.icon(
                  ...
                  icon: Icon(MdiIcons.plus, size: AppSizes.iconSm),
                  label: Text(
                    selectedOptions.isEmpty ? '옵션 연결하기' : '옵션 더 추가',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: AppSizes.sm),
                    Text(
                      '고객이 메뉴를 주문할 때 선택할 수 있는 옵션을\n"옵션 불러오기" 버튼을 클릭하여 추가해보세요!',
                    ...
                    Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(MdiIcons.lightbulbOn, size: 16.sp, color: Colors.blue[700]),
                          SizedBox(width: AppSizes.xs),
                          Text(
                            '예: 사이즈 선택, 토핑 추가, 맛 선택 등',
                            style: TextStyle(
                              fontSize: 12.sp,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                '최대 ${option['maxSelection']}개 선택 가능',
                style: TextStyle(
                  fontSize: 12.sp,
                  fontWeight: FontWeight.w500,
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: AppColors.primary,
                        foregroundColor: Colors.white,
                        padding: EdgeInsets.symmetric(horizontal: AppSizes.xl, vertical: AppSizes.md),
                      ),
                      child: Text(
                        '선택 완료',
                        style: TextStyle(fontWeight: FontWeight.w600),
